...
import numpy as np
import pybullet
from pybulletgym.envs.yc.robots import NavLidarOmnirobot
...
class NavLidarOmniBaseBulletEnv(BaseBulletEnv):
...
class NavLidarOmniBulletEnv(NavLidarOmniBaseBulletEnv):
  ...
  def __init__(self, render=False):
    ...
    NavLidarOmniBaseBulletEnv.__init__(self, self.robot, render)
