...
register(
    id='Omnibase-v1',
    entry_point='pybulletgym.envs.yc.envs.omni2_env:Omni2BulletEnv',
    # timestep_limit=1000, # adjust this ################## !!! #################
    max_episode_steps=1000,
    reward_threshold=1000.0
    )

# Environment for ME5406
register(
    id='Quadruped-v0',
    entry_point='pybulletgym.envs.me5406.envs.quadruped_env:QuadrupedEnv',
    max_episode_steps=1000,
    reward_threshold=1000.0
    )
...
register(
    id='NavOmnibase-v1',
    entry_point='pybulletgym.envs.yc.envs.nav_omni2_env:NavOmni2BulletEnv',
    max_episode_steps=1000,
    reward_threshold=1000.0
    )
