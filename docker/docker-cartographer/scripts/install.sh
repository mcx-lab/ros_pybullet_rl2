...
catkin_make_isolated ${BUILD_FLAGS} -DCMAKE_CXX_STANDARD=14 $@
# Set the compiler standard to be C++14
# From https://github.com/ros/catkin/issues/936#issuecomment-386555155